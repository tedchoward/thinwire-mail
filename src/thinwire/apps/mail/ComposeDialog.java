...
public class ComposeDialog extends Object {
	...
	ComposeDialog() {
		...
		toolBar.getButton("Send").addActionListener(Button.ACTION_CLICK, new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				MessageBox.confirm("Feature not enabled");
			}
		});
		toolBar.addButton("Cancel", MailClient.IMG_PATH + "delete_16x.gif");
		toolBar.getButton("Cancel").addActionListener(Button.ACTION_CLICK, new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		dialog.addPropertyChangeListener(new String[] { Component.PROPERTY_WIDTH, Component.PROPERTY_HEIGHT }, sizeListener);
	}
